        ...
        <section class="beverage-section">
            ...
            <div class="auto-container">
                ...
                <div class="sec-title centered">
                    ...
                    <h2>Industrial Raw Materials – The Backbone of Food & Beverage Innovation</h2>
                    <div class="text">
                ...
                <div class="row clearfix">
                    ...
                    <!-- <div class="image-column col-lg-7 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="image">
                                <img src="images/background/bg37.jpg" alt="">
                            </div>
                            <div class="image-two">
                    ...
                    <div class="content-column col-lg-8 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <!-- Sec Title -->
                            <div class="sec-title">
                                <div class="title">Industrial Raw Materials </div>
                                <h3>Types of raw materials We Offer: </span></h3>
                        ...
                        <ul class="accordion-box">
                            ...
                            <li class="accordion block active-block">
                                ...
                                <div class="acc-content current">
                                    <div class="content">
                                        <div class="text">
                                            <p>All our starch products meet international food safety and industrial standards.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="accordion-box">
                            ...
                            <li class="accordion block">
                                ...
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">
                                            <p>We offer tailored starch solutions based on your specific industry needs.</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="accordion block">
                                ...
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">
                                            <p>Ethically sourced, ensuring consistent performance and quality. </p>
                                        </div>
                                    </div>
                                </div>
                            </li>
